...
## The exercises — `levels/level05_performance/`
...
!!! tip "Prove it, don't trust it"
    `make level05-test` pins correctness (the optimized blur must match the
    ...
    ```bash
    nsys profile  ./build/levels/level05_performance/level05_demo
    ncu --set full ./build/levels/level05_performance/level05_demo
    ```
...
→ Continue to [Level 6 — Shared-Memory Algorithms](level06-shared-memory.md)
