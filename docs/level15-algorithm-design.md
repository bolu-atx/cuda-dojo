...
results into global once. (Level 6/7.) Same idea as hierarchical combine.
...
continue to [Level 16 — The Intra-Kernel Pipeline](level16-tile-pipeline.md).
