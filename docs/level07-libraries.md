...
pre/post-processing so you don't round-trip through DRAM between stages (a Level 9
theme).

## Your reps

- **GEMM pipeline** — implement a naive tiled GEMM yourself (Level 9), then call
...
→ Continue to [Level 8 — Streams & Asynchrony](level08-streams.md)
