...
//
// The perf rule: this turns Level 4/5's "hope the cache catches the reuse" into
...
//     skews the layout — same conflict lesson as Level 5. Padding is the first
...
//     the layout GEMM needs at Level 11.
//
...
// warp. Level 7 replaces that tail with explicit-mask warp shuffles.
//
