...
// COMPLETE worked example — the pattern every Level 6 kernel copies.
//
// A (2r+1)x(2r+1) box blur, edges clamped. The naive version (Level 5's
...
//   - +1 pad on the inner dimension (the bank-conflict lesson from Level 5):
