...
// Level 3 demo: A/B the baseline and the hierarchy-aware version of each
...
int main() {
  ...
  time_transpose("transpose_naive", dojo::level03::transpose_naive);
  time_transpose("transpose_tiled", dojo::level03::transpose_tiled);
  ...
  time_blur("blur3x3_global", dojo::level03::blur3x3_global);
  time_blur("blur3x3_constant", dojo::level03::blur3x3_constant);
